	...
	OpenAPI springBlogPessoalOpenAPI() {
		return new OpenAPI()
				.info(new Info().title("Projeto Blog Pessoal").description("Projeto Blog Pessoal - Generation Brasil")
						...
						.contact(new Contact().name("Ruan Barreto de Santana").url("https://github.com/BarretoRuan")
								.email("barretoruan65@gmail.com")))
				.externalDocs(new ExternalDocumentation().description("Github").url("https://github.com/BarretoRuan"));
	}
